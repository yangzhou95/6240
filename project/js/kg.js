    ...
    var circle = svg.append("g")
        ...
        .on("mouseover", function (node) {
          ...
          if (content == "Symptoms") {
              ...
              content = "Storage".bold().concat(": ",lastFocusNode.Storage,"; ","Address: ".bold(),lastFocusNode.Address,"; ","Phone: ".bold(),lastFocusNode.Phone,"; ","Location: ".bold(),lastFocusNode.Location)
          }else if (content  == "States") {  
              content = lastFocusNode.name.bold().concat("; ",lastFocusNode.Doses_Administered.bold().concat(" doses have been administered"))
